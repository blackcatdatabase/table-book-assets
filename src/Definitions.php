...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'book_id', 'asset_type', 'filename', 'mime_type', 'size_bytes', 'storage_path', 'content_hash', 'download_filename', 'is_encrypted', 'encryption_algo', 'encryption_key_enc', 'encryption_iv', 'encryption_tag', 'encryption_aad', 'encryption_meta', 'key_version', 'key_id', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'book_id', 'asset_type' ], [ 'tenant_id', 'id' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'book_id', 'size_bytes', 'key_id' ]; }
