...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'tenant_id', 'book_id', 'asset_type', 'filename', 'mime_type', 'size_bytes', 'storage_path', 'content_hash', 'download_filename', 'is_encrypted', 'encryption_algo', 'encryption_key_enc', 'encryption_iv', 'encryption_tag', 'encryption_aad', 'encryption_meta', 'key_version', 'key_id', 'created_at' ];
    }
    ...
    {
        $x = [ 'id', 'tenant_id', 'book_id', 'asset_type', 'filename', 'mime_type', 'size_bytes', 'storage_path', 'content_hash', 'download_filename', 'is_encrypted', 'encryption_algo', 'key_version', 'key_id', 'created_at' ];
    ...
    protected function joinable(): array
    {
        ...
        return [ 'tenants' => 'j0', 'books' => 'j1', 'crypto_keys' => 'j2' ];
    }
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\BookAssets\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\BookAssets\Definitions::softDeleteColumn();
