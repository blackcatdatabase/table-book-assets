...
use BlackCat\Database\Packages\BookAssets\Repository\BookAssetRepository;
...
{
    private BookAssetRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new BookAssetRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\BookAssets\Dto\BookAssetDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\BookAssets\Dto\BookAssetDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\BookAssets\Dto\BookAssetDto|null
    {
