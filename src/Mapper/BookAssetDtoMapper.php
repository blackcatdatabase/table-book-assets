...
/**
 * Bidirectional mapper between DB rows and DTO BookAssetDto:
...
final class BookAssetDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'book_id', 'size_bytes', 'key_id' ];
    /** @var string[] */
    ...
    public static function fromRowOrNull(?array $row): ?BookAssetDto
    {
    ...
    public static function toRowNonNull(BookAssetDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(BookAssetDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,BookAssetDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,BookAssetDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(BookAssetDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,BookAssetDto>
     */
