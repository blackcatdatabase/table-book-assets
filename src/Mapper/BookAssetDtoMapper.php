...
namespace BlackCat\Database\Packages\BookAssets\Mapper;

use BlackCat\Database\Packages\BookAssets\Dto\BookAssetDto;
...
final class BookAssetDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'book_id' => 'bookId', 'asset_type' => 'assetType', 'mime_type' => 'mimeType', 'size_bytes' => 'sizeBytes', 'storage_path' => 'storagePath', 'content_hash' => 'contentHash', 'download_filename' => 'downloadFilename', 'is_encrypted' => 'isEncrypted', 'encryption_algo' => 'encryptionAlgo', 'encryption_key_enc' => 'encryptionKeyEnc', 'encryption_iv' => 'encryptionIv', 'encryption_tag' => 'encryptionTag', 'encryption_aad' => 'encryptionAad', 'encryption_meta' => 'encryptionMeta', 'key_version' => 'keyVersion', 'key_id' => 'keyId', 'created_at' => 'createdAt' ];
    /** @var string[] */
    private const BOOL_COLS   = [ 'is_encrypted' ];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'book_id', 'size_bytes', 'key_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'encryption_meta' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'created_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'encryption_key_enc', 'encryption_iv', 'encryption_tag', 'encryption_aad' ];
    /** @var string[] */
    private const NULLABLE    = [ 'id', 'storage_path', 'content_hash', 'download_filename', 'encryption_algo', 'encryption_key_enc', 'encryption_iv', 'encryption_tag', 'encryption_aad', 'encryption_meta', 'key_version', 'key_id' ];
     ...
     */
    public static function fromRow(array $row): BookAssetDto {
        $vals = [];
     ...
     */
    public static function toRow(BookAssetDto $dto, ?array $onlyProps = null): array {
        $out = [];
