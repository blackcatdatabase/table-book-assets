...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'gin_book_assets_enc_meta', 'idx_book_assets_book', 'idx_book_assets_tenant', 'idx_book_assets_type', 'ux_book_assets_tenant_id', 'ux_book_assets_tenant_unique' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'gin_book_assets_enc_meta', 'idx_book_assets_book', 'idx_book_assets_tenant', 'idx_book_assets_type', 'ux_book_assets_tenant_id', 'ux_book_assets_tenant_unique' ],
