...
final class BookAssetsModule implements ModuleInterface {
    ...
    /** @return string[] */
    public function dependencies(): array { return [ 'table-books', 'table-crypto_keys' ]; }
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $indexes = [ 'idx_book_assets_book', 'idx_book_assets_type', 'ux_book_assets_unique' ];
        $fks     = [ 'fk_book_assets_book', 'fk_book_assets_key' ];
        $missingIdx = [];
        $missingFk  = [];
